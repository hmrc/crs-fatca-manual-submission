  ...
  "SubmissionService" - {
    "readAndMaybeCache" - {
      ...
      "should return submissions and cache when shouldCache is true" in {
        ...
        val result = service.getSubmissionHistory(RequestSubmissionHistoryParameters(true, None), "subscriptionId")
      ...
      "should return submissions and not cache when shouldCache is false" in {
        ...
        val result = service.getSubmissionHistory(RequestSubmissionHistoryParameters(false, None), "subscriptionId")
